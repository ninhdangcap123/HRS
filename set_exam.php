	...
	<body>
			...
			<div id="section">
				...
				<div class="content">
						...
						<h3 >Set Tasks Time Table Details</h3><br>
					<?php
						if(isset($_POST["submit"]))
						{
							$edate=$_POST["da"].'-'.$_POST["mo"].'-'.$_POST["ye"];
							
							$sq="insert into task(ENAME,ETYPE,EDATE,SESSION,CLASS,SUB) values ('{$_POST["ename"]}','{$_POST["etype"]}','{$edate}','{$_POST["ses"]}','{$_POST["cla"]}','{$_POST["sub"]}')";
							if($db->query($sq))
							{
				...
				<div class="rbox">
					...
					<button type="submit" class="btn" name="submit">Add Tasks Details</button>
				</form>
