...
INSERT INTO `category` (`CID`, `CNAME`, `CSEC`) VALUES
(1, 'VIII', 'B'),
(2, 'III', 'C'),
(5, 'V', 'A'),
(6, 'III', 'B');
...
INSERT INTO `task` (`EID`, `ENAME`, `ETYPE`, `EDATE`, `SESSION`, `CLASS`, `SUB`) VALUES
...
INSERT INTO `hcategory` (`HID`, `TID`, `CLA`, `SEC`, `SUB`) VALUES
(1, 1, 'VIII', 'A', 'English'),
(4, 4, 'III', 'B', 'English');
...
INSERT INTO `score` (`MID`, `REGNO`, `SUB`, `MARK`, `TERM`, `CLASS`) VALUES
...
INSERT INTO `trainee` (`ID`, `RNO`, `NAME`, `FNAME`, `DOB`, `GEN`, `PHO`, `MAIL`, `ADDR`, `SCLASS`, `SSEC`, `SIMG`, `TID`) VALUES
...
INSERT INTO `course` (`SID`, `SNAME`) VALUES
(1, 'Tamil'),
(2, 'English'),
(3, 'Maths'),
(5, 'Social Science'),
